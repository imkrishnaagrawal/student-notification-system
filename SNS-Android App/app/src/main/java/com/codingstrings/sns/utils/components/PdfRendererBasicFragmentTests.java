 ...
 */
public class PdfRendererBasicFragmentTests extends ActivityInstrumentationTestCase2<PdfActivity> {
    ...
    protected void setUp() throws Exception {
        ...
        mFragment =(PdfRendererBasicFragment) mActivity.getSupportFragmentManager().findFragmentByTag(PdfActivity.FRAGMENT_PDF_RENDERER_BASIC);
    }
