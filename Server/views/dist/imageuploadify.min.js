...
(function ($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function (opts) {
        ...
        this.each(function () {
            ...
            let totalFiles = [];
            let counter = 0;
            let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><span class='imageuploadify-message'><span class="download"><img src="../img/download.png"></img></span><br>Drag Here</span><button type="button"class="btn btn-default btn-c">Select File To Upload</button></div></div>`);
            ...
            const readingFile = (id, file) => {
                ...
                else if (file.type && file.type.search(/image/) != -1) {
                    fReader.onloadend = function (e) {
                        let image = $("<img>");
                        image.attr("src", e.target.result);
                        container.append(image);
            ...
            button.mouseenter(function onMouseEnter(event) {
                button.css("background", "grey").css("color", "white");
            }).mouseleave(function onMouseLeave() {
                button.css("background", "white").css("color", "grey");
            });
